...
const QuestionSection: React.FC<QuestionSectionProps> = ({ 
  ...
  const [showPersonalHelp, setShowPersonalHelp] = React.useState(false);
  const [showExamHelp, setShowExamHelp] = React.useState(false);
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
            <div className="flex justify-between items-center mb-3">
              ...
              <button 
                ...
                className="flex items-center text-[#bd8c0f] hover:text-[#a37a0e] transition-colors text-sm font-medium"
              >
                Qu'est-ce qu'une question personnelle ?
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={`w-4 h-4 ml-1 transition-transform duration-200 ${showPersonalHelp ? 'rotate-180' : ''}`}>
            ...
            {showPersonalHelp && (
              <div className="mb-4 p-4 bg-amber-50 border border-amber-100 rounded-lg text-gray-700 text-sm">
                <p className="mb-2"><strong>Les questions personnelles sont celles que vous vous posez sur le contenu du chapitre.</strong></p>
                <p className="mb-2">Elles peuvent concerner :</p>
                <ul className="list-disc pl-5 space-y-1">
                  <li>Des points que vous n'avez pas bien compris</li>
                  <li>Des liens avec d'autres connaissances ou expériences</li>
                  <li>Des applications pratiques du contenu</li>
                  <li>Des réflexions personnelles sur le sujet</li>
                </ul>
                <p className="mt-2">Ces questions vous aident à approfondir votre compréhension et à personnaliser votre apprentissage.</p>
              </div>
            )}
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
            <div className="flex justify-between items-center mb-3">
              ...
              <button 
                onClick={() => setShowExamHelp(!showExamHelp)}
                className="flex items-center text-[#bd8c0f] hover:text-[#a37a0e] transition-colors text-sm font-medium"
              >
                Qu'est-ce qu'une question d'examen ?
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={`w-4 h-4 ml-1 transition-transform duration-200 ${showExamHelp ? 'rotate-180' : ''}`}>
                  <path fillRule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clipRule="evenodd" />
                </svg>
              </button>
            </div>
            ...
            {showExamHelp && (
              <div className="mb-4 p-4 bg-amber-50 border border-amber-100 rounded-lg text-gray-700 text-sm">
                <p className="mb-2"><strong>Les questions d'examen probables sont celles qu'un professeur pourrait poser lors d'une évaluation.</strong></p>
                <p className="mb-2">Pour créer des questions d'examen efficaces :</p>
                <ul className="list-disc pl-5 space-y-1">
                  <li><strong>Mettez-vous à la place du professeur</strong> : Quels concepts clés voudrait-il vérifier ?</li>
                  <li><strong>Formulez des questions complètes</strong> : Précisez le format attendu (définition, comparaison, analyse...)</li>
                  <li><strong>Proposez des réponses détaillées</strong> : Plus votre réponse est complète et pertinente, plus vous assimilez le contenu</li>
                </ul>
                <p className="mt-2"><strong>Avantage pédagogique</strong> : Plus vous créez de questions d'examen, plus vous assimilez profondément le cours. C'est une technique d'apprentissage actif très efficace !</p>
              </div>
            )}
